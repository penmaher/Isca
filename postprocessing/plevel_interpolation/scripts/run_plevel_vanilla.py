...
#anaconda env for running is py3.6 and not pyisca
...
level_set='flexum_levs' #Default is the standard levels used previously. ssw_diagnostics are the ones blanca requested for MiMa validation
...
for exp_name in exp_name_list:
    for n in range(nfiles):
        for avg_or_daily in avg_or_daily_list:
            ...
            if over_write or (not os.path.isfile(nc_file_out)):
