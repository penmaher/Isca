...
exp = Experiment('frierson_vanilla_sw_flux_out', codebase=cb)
...
diag.add_field('dynamics',   'temp',              time_avg=True, files=['atmos_monthly']) #need daily if outputting 3d daily
...
#diag.add_field('two_stream','flux_lw',        time_avg=True, files=['atmos_monthly']) #LW net up - down
...
diag.add_field('two_stream','swup_sfc',   time_avg=True, files=['atmos_monthly']) #SWUS
diag.add_field('two_stream','swup_toa',   time_avg=True, files=['atmos_monthly']) #SWUT
