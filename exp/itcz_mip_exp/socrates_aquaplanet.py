...
diag.add_field('dynamics',    'ucomp',         files=['atmos_monthly'], time_avg=True)
diag.add_field('dynamics',    'vcomp',         files=['atmos_monthly'], time_avg=True)
diag.add_field('dynamics',    'temp',          files=['atmos_monthly'], time_avg=True)
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        'stellar_constant':1365., #solar constant
